...
export async function configurePagesCommand(_opts = {}) {
    ...
    console.log(chalk.dim('  Worker: ') + chalk.white(proj.workerName ?? 'unknown') + '\n' +
...
//# sourceMappingURL=configure-pages.js.map