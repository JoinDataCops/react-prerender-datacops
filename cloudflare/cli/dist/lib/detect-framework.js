...
export const SSR_FRAMEWORKS = [
    {
        ...
        outputDir: 'out',
        hasBuiltInSsr: true,
        ssrNote: 'Next.js has built-in SSR/SSG — you likely don\'t need prerender-edge.\n' +
    ...
    },
    {
        ...
        outputDir: 'dist',
        hasBuiltInSsr: true,
        ssrNote: 'Nuxt has built-in SSR/SSG — you likely don\'t need prerender-edge.\n' +
    ...
    },
    {
        ...
        hasBuiltInSsr: true,
        ssrNote: 'SvelteKit has built-in SSR — you likely don\'t need prerender-edge.\n' +
    ...
    },
    {
        ...
        outputDir: 'public',
        hasBuiltInSsr: true,
        ssrNote: 'Gatsby generates static HTML at build time — prerender-edge is not needed.\n' +
    ...
    },
    {
        ...
        outputDir: 'dist',
        hasBuiltInSsr: true,
        ssrNote: 'Astro generates static HTML — prerender-edge is not needed for most cases.\n' +
...
export function getUnknownFramework() {
    return {
        name: 'unknown',
